...
class GitHubServer {
  ...
  private setupToolHandlers() {
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request: typeof CallToolRequestSchema['_type']) => {
      ...
      try {
        ...
        switch (name) {
          case 'create_or_update_file': {
            const args = rawArgs as { owner: string; repo: string; path: string; content: string; message: string; branch: string; sha?: string; };
          ...
          case 'push_files': {
            const args = rawArgs as { owner: string; repo: string; branch: string; files: { path: string; content: string; }[]; message: string; };
          ...
          case 'search_repositories': {
            const args = rawArgs as { query: string; page?: number; perPage?: number; };
          ...
          case 'create_repository': {
            const args = rawArgs as { name: string; description?: string; private?: boolean; autoInit?: boolean; };
          ...
          case 'get_file_contents': {
            const args = rawArgs as { owner: string; repo: string; path: string; branch?: string; };
          ...
          case 'create_issue': {
            const args = rawArgs as { owner: string; repo: string; title: string; body?: string; assignees?: string[]; labels?: string[]; milestone?: number; };
          ...
          case 'create_pull_request': {
            const args = rawArgs as { owner: string; repo: string; title: string; body?: string; head: string; base: string; draft?: boolean; maintainer_can_modify?: boolean; };
            response = await this.axiosInstance.post(
          ...
          case 'fork_repository': {
            const args = rawArgs as { owner: string; repo: string; organization?: string; };
            response = await this.axiosInstance.post(
          ...
          case 'create_branch': {
            const args = rawArgs as { owner: string; repo: string; branch: string; from_branch?: string; };
            // Get the SHA of the base branch
            const { data: baseBranch } = await this.axiosInstance.get(
              `/repos/${args.owner}/${args.repo}/branches/${args.from_branch || 'main'}`
            );
          ...
          case 'list_commits': {
            const args = rawArgs as { owner: string; repo: string; sha?: string; page?: number; perPage?: number; };
            response = await this.axiosInstance.get(
              `/repos/${args.owner}/${args.repo}/commits`,
              {
          ...
          case 'list_issues': {
            const args = rawArgs as { owner: string; repo: string; state?: 'open' | 'closed' | 'all'; labels?: string[]; sort?: 'created' | 'updated' | 'comments'; direction?: 'asc' | 'desc'; since?: string; page?: number; per_page?: number; };
            response = await this.axiosInstance.get(
              `/repos/${args.owner}/${args.repo}/issues`,
              {
                params: {
          ...
          case 'update_issue': {
            const args = rawArgs as { owner: string; repo: string; issue_number: number; title?: string; body?: string; state?: 'open' | 'closed'; labels?: string[]; assignees?: string[]; milestone?: number; };
          ...
          case 'add_issue_comment': {
            const args = rawArgs as { owner: string; repo: string; issue_number: number; body: string; };
            response = await this.axiosInstance.post(
          ...
          case 'search_code': {
            const args = rawArgs as { q: string; sort?: string; order?: 'asc' | 'desc'; per_page?: number; page?: number; };
          ...
          case 'get_issue': {
            const args = rawArgs as { owner: string; repo: string; issue_number: number; };
            response = await this.axiosInstance.get(
              `/repos/${args.owner}/${args.repo}/issues/${args.issue_number}`
            );
            break;
          ...
          case 'get_pull_request': {
            const args = rawArgs as { owner: string; repo: string; pull_number: number; };
            response = await this.axiosInstance.get(
          ...
          case 'list_pull_requests': {
            const args = rawArgs as { owner: string; repo: string; state?: 'open' | 'closed' | 'all'; head?: string; base?: string; sort?: 'created' | 'updated' | 'popularity' | 'long-running'; direction?: 'asc' | 'desc'; per_page?: number; page?: number; };
            response = await this.axiosInstance.get(
              `/repos/${args.owner}/${args.repo}/pulls`,
              {
                params: {
          ...
          case 'create_pull_request_review': {
            const args = rawArgs as { owner: string; repo: string; pull_number: number; commit_id?: string; body: string; event: 'APPROVE' | 'REQUEST_CHANGES' | 'COMMENT'; comments?: { path: string; position: number; body: string; }[]; };
            response = await this.axiosInstance.post(
          ...
          case 'merge_pull_request': {
            const args = rawArgs as { owner: string; repo: string; pull_number: number; commit_title?: string; commit_message?: string; merge_method?: 'merge' | 'squash' | 'rebase'; };
            response = await this.axiosInstance.put(
          ...
          case 'update_pull_request_branch': {
            const args = rawArgs as { owner: string; repo: string; pull_number: number; expected_head_sha?: string; };
            response = await this.axiosInstance.put(
